    ...
    <form ref={formRef} action={action} className="flex flex-col gap-6">
      ...
      <div>
        ...
        <input
          ...
          step="0.01"
          name="amount"
          className="w-full text-3xl bg-transparent border-b-2 border-zinc-800 focus:border-emerald-500 pb-2 outline-none text-white placeholder-zinc-700 transition-all"
          placeholder="0.00"
          required
          autoFocus
        />
      ...
      <div>
        ...
        <input
          type="text"
          name="concept"
          className="w-full bg-zinc-900 rounded-xl px-4 py-3 text-white border border-zinc-800 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all"
      ...
      <div>
        <label className="flex items-center justify-between p-4 rounded-xl border border-zinc-800 bg-zinc-900 cursor-pointer transition-colors hover:border-emerald-500/50">
          ...
          <div className="relative inline-flex items-center ml-4 cursor-pointer">
            <input type="checkbox" name="is_refundable" className="sr-only peer" />
